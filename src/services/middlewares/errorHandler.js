...
const errorHandler = (error, req, res, next) => {
    ...
    console.log("Error:", error); // Agrega esta línea para ver el error
    console.log("Request:", req); // Agrega esta línea para ver la solicitud
    console.log("Response:", res); // Agrega esta línea para ver la respuesta
    console.log("Next:", next); // Agrega esta línea para ver el siguiente middleware
    switch (error.code) {
